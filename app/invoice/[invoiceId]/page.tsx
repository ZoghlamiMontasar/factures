...
const page = ({params} : {params:Promise<{invoiceId : string}>}) => {
    ...
    useEffect(() => {
       ...
       const handeleStatusChange = (e : React.ChangeEvent<HTMLSelectElement>) =>{
       ...
       const handleDelete = async () => {
        const confirmed = window.confirm("Etres-vous sur de vouloir supprimer cette facture ?")
        if(confirmed){
         try {
