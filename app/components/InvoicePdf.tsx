...
const InvoicePDF: React.FC<FacturePDFProps> = ({ invoice, totals }) => {
  const factureRef = useRef<HTMLDivElement>(null)//REFERANCE A LA DIV QUI EN T2LECHARGE
  ...
  return (
    <div className="mt-4 lg:block">
      <div className="border-base-300 border-2 border-dashed rounded-xl p-5">
        ...
        <div className="p-8" ref={factureRef}> {/*referance de l élement quand a télécharger*/}
